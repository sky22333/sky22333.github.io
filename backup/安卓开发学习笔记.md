...
目标 SDK 37 (Android 17) → 跟随 Play 商店要求。

编译 SDK 37 → 保持最新 API 能力。
```
## gradle构建工具
```
...
```
```
https://services.gradle.org/distributions/gradle-8.14.5-wrapper.jar
...
IDE：https://developer.android.com/studio/intro?hl=zh-cn
